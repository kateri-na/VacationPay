...
public class VacationPayController {
    ...
    @GetMapping
    public Double calculation(@RequestParam(value = "yearAverageSalary", required = false) Double yearAverageSalary,
        ...
        if (yearAverageSalary != null && numberOfVacationDays != null) {
            if(startOfVacation != null && endOfVacation != null)
                return service.calculateVacationPay(yearAverageSalary, numberOfVacationDays, startOfVacation, endOfVacation);
            else
                return service.calculateVacationPay(yearAverageSalary, numberOfVacationDays);
        }
        return null;
    }
}